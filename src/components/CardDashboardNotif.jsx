    ...
    props.ordersWithMessages.forEach((array) => {
      const projectFields = {
        ...
        comments: array.comments.filter(
          (arr) => arr.user && arr.user._id !== currentUser._id
        ),
      };
                ...
                return (
                  ...
                  >
                    <Typography color="textSecondary">
                      ...
                      {arr.comments[arr.comments.length - 1].user.lastName} at
                      {dayjs(
                        `${arr.comments[arr.comments.length - 1].timeStamp}`
                      ).format("DD/MM/YYYY")}
                      {" : "}
